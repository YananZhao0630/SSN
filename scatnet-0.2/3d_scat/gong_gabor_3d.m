...
function gab = gong_gabor_3d(N, M, K, sigma0, slant, xi, theta, offset, precision)
    ...
    A = Rth \ [1/sigma0^2 0 0;0 slant(2)^2/sigma0^2 0 ; 0 0 slant(1)^2/sigma0^2] * Rth;
     %A = Rth;
	...
	gab=1/(2*pi*sigma0^2/(slant(1)*slant(2))^2)*fftshift(gabc);
