...
%%
% %%以Bern-SAR图片为例
BernSAR_im1=imread('./Bern-SAR/im1.bmp');
BernSAR_im1=rgb2gray(BernSAR_im1);
BernSAR_im2=imread('./Bern-SAR/im2.bmp');
...
%%Ottawa-SAR
%%
OttawaSAR_im1=imread('./Ottawa-SAR/im1.bmp');
OttawaSAR_im1=rgb2gray(OttawaSAR_im1);
OttawaSAR_im2=imread('./Ottawa-SAR/im2.bmp');
OttawaSAR_im2=rgb2gray(OttawaSAR_im2);
OttawaSAR_changed_map=imread('./Ottawa-SAR/changed_map.bmp');
OttawaSAR_changed_map=rgb2gray(OttawaSAR_changed_map);%传统方法得到的结果
%%
%%Yellow_River
Yellow_River_im1=imread('./Yellow River I-SAR/im1.bmp');
Yellow_River_im2=imread('./Yellow River I-SAR/im2.bmp');
