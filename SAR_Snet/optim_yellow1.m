%% This code is for the optimization of the Yellow River1 dataset
%% Initialization 
%clc;clear;
% sample image
clc;clear;
...
im_gt = load('mask_test.mat');
fprintf(' ... ... read image file finished !!! !!!\n\n');

im1 = double(im1.data);
im2 = double(im2.data);
im_gt = double(im_gt.mask_test);
[ylen, xlen] = size(im1);
...
pixel_gt = reshape(im_gt-1, ylen*xlen, 1);
