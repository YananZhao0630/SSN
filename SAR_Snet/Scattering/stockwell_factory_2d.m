...
function [Wop, filters] = stockwell_factory_2d(size_in, filt_opt, scat_opt)
    % Options
    ...
    white_list_filt = {'filter_type', 'precision', 'Q', 'J', 'L',...
        'sigma_phi','sigma_psi','xi_psi','slant_psi', 'min_margin','chirp_rate', 'basis'};
    ...
    switch filt_opt.filter_type
        ...
        case 'stockwell'
            filt_opt = rmfield(filt_opt, 'filter_type');
            filters = stockwell_filter_bank_2d(size_in, filt_opt);
        case 'shannon'
            filt_opt = rmfield(filt_opt, 'filter_type');
